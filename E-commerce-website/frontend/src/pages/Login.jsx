const Login = () => {
  return (
      <section className={'max_padd_container flexCenter flex-col pt-32'}>
        <div className={'max-w-[555px] h-[600px] bg-teal-50 m-auto px-14 py-10 rounded-md'}>
          ...
          <p className={'text-black font-bold'}>Already have an account? <span className={'text-blue-600 underline cursor-pointer'}>Login</span></p>
